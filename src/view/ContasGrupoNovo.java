 ...
 * @author Usuário
 */
public class ContasGrupoNovo extends javax.swing.JFrame {
    
    /**
     * Creates new form ContasGrupoPerfil
     */
    public ContasGrupoNovo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContasGrupoNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContasGrupoNovo().setVisible(true);
            }
        });
    }
